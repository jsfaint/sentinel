...
const (
	apiLoginURL        = "https://account.onethingpcs.com/user/login?appversion=" + appVersion
	...
	apiCheckAccountURL = "https://account.onethingpcs.com/user/check?appversion=" + appVersion
